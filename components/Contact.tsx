...
const ImageClipBox = ({ src, clipClass }: ImageClipBoxProps) => (
  <div className={clipClass}>
    <Image src={src} alt="contact image" fill className="object-cover" />
  </div>
);
      ...
      <div className="relative rounded-lg bg-black py-24 text-primary-50 sm:overflow-hidden">
        <div className="absolute -left-20 top-0 hidden h-full w-72 overflow-hidden sm:block lg:left-10 lg:w-96">
          ...
          <ImageClipBox
            ...
            clipClass="contact-clip-path-2 lg:transalate-y-40 transalate-y-60"
          />
        </div>
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <Button title="contact us" containerClass="mt-10 cursor-pointer bg-primary-50" />
        </div>
      </div>
    </div>
  );
