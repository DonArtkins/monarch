...
const WEAPON_CARDS: WeaponCard[] = [
  {
    ...
    imageSrc: "/images/system-ui.jpeg", // TODO: Replace with /images/WEAPON_IMG_01.webp
    imageAlt:
  ...
  },
  {
    ...
    imageSrc: "/images/kamish.jpeg", // TODO: Replace with /images/WEAPON_IMG_02.webp
    imageAlt:
        ...
        <div className="weapons-grid grid grid-cols-1 md:grid-cols-5 gap-5 md:gap-6 items-start">
          ...
          >
            ...
            >
              {/* Background image */}
              <Image
                src="/images/beru.jpeg" // TODO: Replace with /images/ARMY_IMG_01.webp — Igris with sword exiting frame
