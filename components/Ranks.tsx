  ...
  return (
    <div
      ...
      style={{
        ...
        border: `1px solid var(--monarch-ice-border)`,
      }}
      role="article"
...
const Ranks = () => {
  ...
  return (
    <section
      id="ranks"
      ref={containerRef}
      className="relative min-h-dvh w-screen overflow-hidden py-20 md:py-32 bg-monarch-ice-white"
    >
