...
const MONARCH_PANELS: MonarchPanel[] = [
  {
    ...
    imageSrc: "/images/system-ui.jpeg", // TODO: Replace with /images/MONARCH_IMG_01.webp
    imageAlt:
  ...
  },
  {
    ...
    imageSrc: "/images/about-bg.jpeg", // TODO: Replace with /images/MONARCH_IMG_02.webp
    imageAlt:
  ...
  },
  {
    ...
    imageSrc: "/images/footer-bg.jpeg", // TODO: Replace with /images/MONARCH_IMG_03.webp
    imageAlt:
...
const MonarchPanelComponent = ({
  ...
  return (
    <div
      ref={panelRef}
      className="monarch-panel relative overflow-hidden rounded-lg flex flex-col h-full"
      style={{
        ...
        <div className="monarchs-grid grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-6">
          {MONARCH_PANELS.map((panel, index) => (
            <div key={panel.id} className="h-full">
              <MonarchPanelComponent panel={panel} index={index} />
            </div>
          ))}
        </div>
