...
### SPEC 01 — Story-Based Navigation Refinement
...
### SPEC 02 — Custom Shadow Energy Cursor
...
### SPEC 03 — Gate Crack Preloader (Entry Experience)
...
### SPEC 04 — Film Grain + Noise Texture Global Overlay
...
### SPEC 05 — Typography System Upgrade
...
### SPEC 06 — Color System + Depth Layers
...
### SPEC 07 — Hero Videos (5 Clips, Light Background Like Zentry)
...
### SPEC 08 — Hero Hexagonal Particle System
...
### SPEC 09 — Portal Scroll Expansion (Double Dungeon Image)
...
### SPEC 10 — Origin Copy Block ("Before The System")
...
### SPEC 11 — Bento Card 01: "THE SYSTEM" — Rotating Status Windows Video
...
### SPEC 12 — Bento Card 02: "ARISE" — Jin-Woo Monarch Transformation Video
...
### SPEC 13 — Bento Card 03: "SHADOW ARMY" — Igris Battle Video
...
### SPEC 14 — Bento Card 04: "DUNGEONS" — S-Rank Interior Video
...
### SPEC 15 — Bento Card 05: "ARISE" — CTA Card
...
### SPEC 16 — Bento Card 06: "THE GATES" — Gate Opening Video
...
### SPEC 17 — Bento Card Glass Shimmer + Tilt Effect
...
### SPEC 18 — Red Gate Frame-by-Frame Hover Section
...
### SPEC 19 — Dark ↔ Light Realm Shift Transition
...
### SPEC 20 — The Ranks: E Through S Visual Progression
...
### SPEC 21 — Shadow Extraction Story Cards
...
### SPEC 22 — The Monarchs: The Architect + Temple Statues
...
### SPEC 23 — Weapons of the Shadow Monarch
...
### SPEC 24 — Shadow Army CTA (Replaces Current "LET'S BUILD" Section)
...
### SPEC 25 — "Beyond Season 2" Story Teaser
...
### SPEC 26 — Footer Refinement ("THE SHADOW ARMY ARISE")
...
### SPEC 27 — The Failed Arise / Reimagined Success Scene
...
### SPEC 29 — Scroll Copy Voice — Second Person Narrative
...
### SPEC 30 — Performance, Lazy Loading + Mobile
